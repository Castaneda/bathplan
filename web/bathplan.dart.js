...
$$.InputElement = {"": "Element;height},width}", $isElement: true, $asElement: null, $isEventTarget: true, $asEventTarget: null};
...
InfoBlock: {"": "Object;infoBlock,cordsParagraph,tileParagraph,cords,tileInfo",
  InfoBlock$0: function() {
    this.infoBlock = document.querySelector("#infoBlock");
    var t1 = this.infoBlock.style;
    t1.set$border;
    $.setProperty$3$x(t1, "border", "1px solid grey", "");
    this.cordsParagraph = document.createElement("p");
    this.tileParagraph = document.createElement("p");
    t1 = this.infoBlock;
    t1.get$nodes;
    new $._ChildNodeListLazy(t1)._this.appendChild(this.cordsParagraph);
    t1 = this.infoBlock;
    t1.get$nodes;
    new $._ChildNodeListLazy(t1)._this.appendChild(this.tileParagraph);
    this.cordsParagraph.textContent = "Cords paragraph";
    this.tileParagraph.textContent = "Tile info";
  }
},

Room: {"": "Object;context,height,width,infoBlock,tileSet,tiles",
  drawWalls$0: function() {
    var wallWidth, wallHeight, i, xPosition;
    this.context.strokeStyle = "#000";
    this.context.shadowBlur = 0;
    this.context.shadowOffsetX = 0;
    this.context.shadowOffsetY = 0;
    this.context.font = "25px sans-serif";
    wallWidth = $.$div$n(this.width, 4);
    wallHeight = this.height;
    this.tiles = $.List_List($);
    for (i = 0; i < 4; ++i) {
      xPosition = i * wallWidth;
  ...
  onMouseMove$1: function(_, $event) {
    ...
    x = t1.get$offsetX($event);
    y = t1.get$offsetY($event);
    t1 = this.infoBlock;
    t2 = "x = " + $.S(x) + ", y = " + $.S(y);
    t1.cordsParagraph.textContent = t2;
  },
  ...
  onMouseUp$1: function(_, $event) {
    ...
    x = t1.get$offsetX($event);
    y = t1.get$offsetY($event);
    for (t1 = $.get$iterator$ax(this.tiles); t1.moveNext$0();)
      t1.get$current().changeTileColor$2(x, y);
  },
  ...
  Room$1: function(canvas) {
    ...
    this.context = t1.get$context2d(canvas);
    t1 = canvas.style;
    t1.set$border;
    $.setProperty$3$x(t1, "border", "1px solid grey", "");
    this.infoBlock = $.InfoBlock$();
    t1 = new $._EventStream(window, $.EventStreamProvider_resize._eventType, false);
    t1 = new $._EventStreamSubscription(0, t1._target, t1._eventType, this.get$onResize(this), t1._useCapture);
    t2 = t1._onData;
    if (t2 != null && !t1.get$isPaused())
      $.$$dom_addEventListener$3$x(t1._target, t1._eventType, t2, t1._useCapture);
    canvas.get$onMouseMove;
    t1 = new $._EventStream(canvas, $.EventStreamProvider_mousemove._eventType, false);
    t1 = new $._EventStreamSubscription(0, t1._target, t1._eventType, this.get$onMouseMove(this), t1._useCapture);
    t2 = t1._onData;
    if (t2 != null && !t1.get$isPaused())
      $.$$dom_addEventListener$3$x(t1._target, t1._eventType, t2, t1._useCapture);
    canvas.get$onMouseUp;
    t1 = new $._EventStream(canvas, $.EventStreamProvider_mouseup._eventType, false);
    t1 = new $._EventStreamSubscription(0, t1._target, t1._eventType, this.get$onMouseUp(this), t1._useCapture);
    t2 = t1._onData;
    if (t2 != null && !t1.get$isPaused())
      $.$$dom_addEventListener$3$x(t1._target, t1._eventType, t2, t1._useCapture);
    this.drawWalls$0();
...
Tile: {"": "Drawable;context,row,col,width,height,startX,color,x>,y>,lib2$Drawable$x,lib2$Drawable$y,needsUpdate",
  ...
  printInfo$1: function(infoBlock) {
    ...
    infoBlock.tileParagraph.textContent = t1;
  },
  isPointInside$2: function(pX, pY) {
    var t1, t2;
    t1 = this.x;
    t2 = $.getInterceptor$n(pX);
    if (t2.$gt(pX, t1) && t2.$lt(pX, t1 + this.width)) {
      t1 = this.y;
      t2 = $.getInterceptor$n(pY);
      t1 = t2.$gt(pY, t1) && t2.$lt(pY, t1 + this.height);
    } else
      t1 = false;
    if (t1)
      return true;
  ...
  TileSet$6: function(rows, cols, wallWidth, wallHeight, xPosition, infoBlock) {
    ...
    for (t5 = this.xPosition, row = 0; row < t4; row = hRow) {
      ...
      for (hRow = row + 1, col = 0; col < t2; col = hCol) {
        ...
        t6.cordsParagraph.textContent = t7;
        $.add$1$ax(this.tileRow, tile);
      }
...
InfoBlock$: function() {
  var t1 = new $.InfoBlock(null, null, null, null, null);
  t1.InfoBlock$0();
  return t1;
},

Room$: function(canvas) {
...
//@ sourceMappingURL=bathplan.dart.js.map
